export const projects = [
  ...
  {
    id: "agroguard",
    title: "Tech Training — AI, IoT, and Python",
    category: "IoT + AI",
    description: "Comprehensive tech training program covering AI, IoT, and Python programming for hands-on learning and real-world applications.",
    tech: ["Python", "AI/ML", "Raspberry Pi"],
    metrics: [
      "Python programming",
      "AI/ML concepts",
      "PictoBlocks visual programming",
    ],
    image: "/images/scratch_students.jpg",
    github: "https://github.com/Muwatta/tech-training",
    live: null,
    featured: true,
  },
  {
